...
<head>
  ...
  <link rel="preload" as="style" href="assets/mobirise/css/mbr-additional.css"><link rel="stylesheet" href="assets/mobirise/css/mbr-additional.css" type="text/css">
    ...
    <body>    
        ...
        <section data-bs-version="5.1" class="header1 cid-tA7nekUY5H mbr-fullscreen" data-bg-video="https://www.youtube.com/watch?v=Y8ACyHYsb6Q&amp;ab_channel=Cloud9" id="header1-n">
            <div class="mbr-fallback-image disabled"></div>
            <div class="mbr-overlay" style="opacity: 0.1; background-color: rgb(250, 250, 250);"></div>
            <div class="container">
                <div class="row">
                    <div class="col-12 col-lg-5">
                        <h1 class="mbr-section-title mbr-fonts-style mb-3 display-1"><strong>LIRCAYHUB</strong></h1>
                        
                        <p class="mbr-text mbr-fonts-style display-7">En LIRCAYHUB Estamos interesados en ofrecer distintos tipos de servicio abarcando y satisfaciendo todas las necesidades que el cliente necesite.<br></p>
                        <div class="mbr-section-btn mt-3"><a class="btn btn-secondary display-4" href="page1.php">Registrar Ahora</a></div>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="title col-12 col-md-9">
                        <h3 class="mbr-section-title mbr-fonts-style align-center mb-4 display-2"><strong>¿Quiénes somos?</strong></h3>
                        <h4 class="mbr-section-subtitle align-center mbr-fonts-style mb-4 display-7"><div>Somos una empresa de servicios que ofrece una combinación única de limpieza de autos y reparaciones de bicicletas de alta calidad. Nuestro objetivo es ayudar a nuestros clientes a mantener sus vehículos de transportes en optimas condiciones. Contamos con un equipo altamente capacitado de técnicos y limpiadores que se aseguran de que cada vehículo sea tratado con el cuidado y la atención que merece. Ofrecemos servicios de limpieza de autos que van desde lavados básicos hasta tratamientos de cera y pulido de pintura, mientras que nuestros servicios de reparación de bicicletas incluyen desde ajustes de frenos y cambios hasta reparaciones de llantas y de sistemas de transmisión.&nbsp;</div></h4>
                        
                    </div>
                </div>
            </div>
        </section>
        <section data-bs-version="5.1" class="share3 cid-tA7w79OYP6" id="share3-q">
            <div class="container">
        ...
        <section data-bs-version="5.1" class="footer7 cid-tA7vYusjj8" once="footers" id="footer7-p">
        <div class="container">
