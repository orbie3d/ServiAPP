...
<?php
    ...
    if (isset($_POST['create'])) {
        ...
        $queryInsert = "INSERT INTO contacto (nombre,email,telefono,direccion,fecha,servicio) VALUES ('".$nombre."','".$email."','".$telefono."','".$direccion."','".$fecha."','".$servicio."')";
                    ...
                    <form method="POST" class="mbr-form form-with-styler mx-auto" data-form-title="Form Name">
                        ...
                        <!--SERVICIO-->
                            <div class="dragArea row">
                                ...
                                <div data-for="direccion" class="col-lg-12 col-md-12 col-sm-12 form-group mb-3">
                                    <input required type="direccion" name="direccion" placeholder="Dirección" data-form-field="direccion" class="form-control" value="" id="telefono-form7-1h">
                                </div>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 form-group mb-3" data-for="servicio">
                                    ...
                                    <input readonly value="Limpieza de Hogar" type="text" name="servicio" placeholder="" data-form-field="servicio" class="form-control" value="" id="servicio-form7-1h">
                                </div>
