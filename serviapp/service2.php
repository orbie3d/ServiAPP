                        ...
                        <!--SERVICIO-->
                            <div class="dragArea row">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 form-group mb-3" data-for="servicio">
                                    ...
                                    <input readonly value="Lavado profundo del automóvil $20.000" type="text" name="servicio" placeholder="" data-form-field="servicio" class="form-control" value="" id="servicio-form7-1h">
                                </div>
