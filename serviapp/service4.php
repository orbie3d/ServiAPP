...
<body>
    ...
    <section data-bs-version="5.1" class="form7 cid-tAd8v1uWgb" id="form7-1h">
        ...
        <div class="mbr-section-head">
                <h3 class="mbr-section-title mbr-fonts-style align-center mb-0 display-2"><strong>Servicio de Bicicletas</strong></h3>
                        ...
                        <!--SERVICIO-->
                            <div class="dragArea row">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 form-group mb-3" data-for="servicio">
                                    ...
                                    <input readonly value="Servicio de bicicleta - mantenimiento $10.000" type="text" name="servicio" placeholder="" data-form-field="servicio" class="form-control" value="" id="servicio-form7-1h">
                                </div>
